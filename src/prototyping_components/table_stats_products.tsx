export default function table_stats_products(){
let product_data=["Apple", "Banana", "Orange", "Mango", "Pineapple", "Grapes", "Strawberry", "Watermelon"]
...
let products = product_data.map((item) => {
    return (<p>{item}</p>);
});
