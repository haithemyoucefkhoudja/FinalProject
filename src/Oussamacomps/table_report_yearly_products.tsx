export default function table_report_yearly_products(){
let warehouse_data=["product 1", "product 2", "product 3", "product 4", "product 5", "product 6", "product 7"]
...
let years_data= [2024,2023,2022,2021,2020,2019,2018,2017,2016,2015,2014,2013,2012,2011,2010,2009,2008,2007,2006,2005,2004,2003];
