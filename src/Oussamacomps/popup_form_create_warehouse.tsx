export default function Popup_form_create_warehouse (props:any){
...
return (
    ...
    <div className="flex justify-center items-center text-black w-[40vw] h-[40vh] rounded-[1rem] p-[1rem] border black-border absolute top-[50%] left-[50%] transform translate-x-[-50%] translate-y-[-50%] bg-white"> 
      <p className="fixed top-[1%] right-[1%] text-[1.5em] text-[red]" onClick={handleClick}>X</p>
      		...
      		<p className="absolute left-[37%] top-[5%]  h-[50%] ">Create warehouse</p>
      		<div className="flex flex-col justify-between h-[40%] ">
      	    	...
      	    	<div className=" flex w-[71%] justify-between"><p>Location</p><button className="p-[0.5rem] text-[0.85em] rounded bg-white border black-border rounded outline-none">Mapping</button></div>
      		</div>
