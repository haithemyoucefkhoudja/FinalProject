'use client';
import {   Common, Factory } from "@/types/Data";
import { X } from "lucide-react";
import { useState } from "react";

  
export const TableFactory = ({Warehouse, company}:{Warehouse:Common, company:string}) => {
    if(!Warehouse)
      return(
    ...
    <div className="flex p-6 flex-col space-y-2 items-center justify-center text-5xl">
      ...
      <p className="text-sm text-gray-500">F:{Warehouse.name && Warehouse.name}</p>
    </div>
