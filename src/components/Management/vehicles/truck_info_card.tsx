...
import Popup_form_create_truck from './popup_form_create_truck.tsx'
...
export default function(props:Props) {
	...
	<div className="w-[35vw] h-[20vh] border border-black rounded flex justify-between text-[1em] relative">
		<div className="flex flex-col  text-[1.25em] w-[50%]  m-[1rem]">
			<p className="">Model: {Data.model}</p>
			<p className="">Id: {Data.id}</p>
		</div>


		<div className="flex text-[1.25em]  h-[100%] w-[40%] flex-col  m-[1rem] ">
